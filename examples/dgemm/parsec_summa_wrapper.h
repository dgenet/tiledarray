...
namespace Parsec {
    ...
    namespace {
        ...
        void summa_destruct(parsec_taskpool_t * handle);
        
        template <>
        void summa_destruct<double>(parsec_taskpool_t * handle) {
            dplasma_dsumma_Destruct( handle );
        }
        template <>
        void summa_destruct<float>(parsec_taskpool_t * handle) {
            dplasma_ssumma_Destruct( handle );
        }
        template <>
        void summa_destruct<std::complex<double>>(parsec_taskpool_t * handle) {
            dplasma_zsumma_Destruct( handle );
        }
        template <>
        void summa_destruct<std::complex<float>>(parsec_taskpool_t * handle) {
            dplasma_csumma_Destruct( handle );
        }
        ...
        struct summa_handle_new_fct {
            static parsec_taskpool_t *create(PLASMA_enum transA, PLASMA_enum transB,
                                          Real alpha,
        ...
        struct summa_handle_new_fct<double, TileA, TileB, TileC, Policy, Op> {
            static parsec_taskpool_t *create(PLASMA_enum transA, PLASMA_enum transB,
                                          ...
                                          IrregularTiledMatrix<TileC, Policy, Op> &C)
            {
                return dplasma_dsumma_New(transA, transB, alpha, A.desc(), B.desc(), C.desc());
            }
        };
        ...
        struct summa_handle_new_fct<float, TileA, TileB, TileC, Policy, Op> {
            static parsec_taskpool_t *create(PLASMA_enum transA, PLASMA_enum transB,
                                          ...
                                          IrregularTiledMatrix<TileC, Policy, Op> &C)
            {
                return dplasma_ssumma_New(transA, transB, alpha, A.desc(), B.desc(), C.desc());
            }
        };
        ...
        struct summa_handle_new_fct<std::complex<double>, TileA, TileB, TileC, Policy, Op> {
            static parsec_taskpool_t *create(PLASMA_enum transA, PLASMA_enum transB,
                                          ...
                                          IrregularTiledMatrix<TileC, Policy, Op> &C)
            {
                return dplasma_zsumma_New(transA, transB, alpha, A.desc(), B.desc(), C.desc());
            }
        };
        ...
        struct summa_handle_new_fct<std::complex<float>, TileA, TileB, TileC, Policy, Op> {
            static parsec_taskpool_t *create(PLASMA_enum transA, PLASMA_enum transB,
                                          ...
                                          IrregularTiledMatrix<TileC, Policy, Op> &C)
            {
                return dplasma_csumma_New(transA, transB, alpha, A.desc(), B.desc(), C.desc());
            }
        };        
    }
    ...
    public:
        ...
        void run(void) {
            if( NULL == parsec_handle_ || NULL == parsec_context_)
                return;
            /*
            parsec_taskpool_t *madness_handle = &madness::madness_handle;
            ...
            */
            ...
            parsec_ptg_taskpool_wait(parsec_context_, parsec_handle_);
